...
xst -ifn xst.scr
move dcm_user_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dcm_user_clk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm_user_clk_exdes.ucf dcm_user_clk_exdes

echo 'Running map'
map -timing -pr b dcm_user_clk_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm dcm_user_clk_exdes -w routed.ncd routed.vhd
cd ..
