...
end entity REB_v5_cmd_interpreter;
...
architecture Behavioral of REB_v5_cmd_interpreter is
  ...
  signal next_ccd_3_seq_override_wr : std_logic;
...
begin
  ...
  begin
    ...
    if rising_edge(clk) then
      if (reset = '1') then
        ...
        ccd_3_seq_override_wr <= next_ccd_3_seq_override_wr;
  ...
  process (
           pres_state, regReq, regOP, RegAddr, regdatawr_masked, regwren,
    -- BRS
    ...
    -- sequencer
           ...
           ccd_1_seq_override_read, ccd_2_seq_override_read, ccd_3_seq_override_read,
    -- ASPIC
    ...
    -- V&I measure
           ...
           Mgt_avcc_ok, Mgt_avtt_ok, V3_3v_ok,
           ccd_1_bias_gd_thresh, ccd_1_bias_od_thresh, ccd_1_bias_rd_thresh,
           ccd_2_bias_gd_thresh, ccd_2_bias_od_thresh, ccd_2_bias_rd_thresh,
           ccd_3_bias_gd_thresh, ccd_3_bias_od_thresh, ccd_3_bias_rd_thresh,
    -- PCB temp
  ...
  begin
    ...
    case pres_state is
      ...
      when ccd_3_seq_override_rd_state =>
        ...
        next_state                  <= wait_end_cmd;
        next_regDataRd(31 downto 0) <= ccd_3_seq_override_read;
        next_regAck                 <= '1';
