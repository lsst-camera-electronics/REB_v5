...
set_property PACKAGE_PIN K26 [get_ports {adc_data_t_ccd[0][0]}]
set_property PACKAGE_PIN L24 [get_ports {adc_data_b_ccd[0][0]}]
set_property PACKAGE_PIN M20 [get_ports {adc_data_t_ccd[0][1]}]
set_property PACKAGE_PIN L25 [get_ports {adc_data_b_ccd[0][1]}]
set_property PACKAGE_PIN M25 [get_ports {adc_data_t_ccd[0][2]}]
set_property PACKAGE_PIN M24 [get_ports {adc_data_b_ccd[0][2]}]
set_property PACKAGE_PIN M26 [get_ports {adc_data_t_ccd[0][3]}]
set_property PACKAGE_PIN N24 [get_ports {adc_data_b_ccd[0][3]}]
set_property PACKAGE_PIN R26 [get_ports {adc_data_t_ccd[0][4]}]
set_property PACKAGE_PIN R25 [get_ports {adc_data_b_ccd[0][4]}]
set_property PACKAGE_PIN N19 [get_ports {adc_data_t_ccd[0][5]}]
set_property PACKAGE_PIN N26 [get_ports {adc_data_b_ccd[0][5]}]
set_property PACKAGE_PIN P19 [get_ports {adc_data_t_ccd[0][6]}]
set_property PACKAGE_PIN P24 [get_ports {adc_data_b_ccd[0][6]}]
set_property PACKAGE_PIN P25 [get_ports {adc_data_t_ccd[0][7]}]
set_property PACKAGE_PIN P26 [get_ports {adc_data_b_ccd[0][7]}]

#ASPIC signals (Bank 32)

set_property PACKAGE_PIN AD20 [get_ports {ASPIC_r_up_ccd_p[0]}]
set_property PACKAGE_PIN AE20 [get_ports {ASPIC_r_up_ccd_n[0]}]
set_property PACKAGE_PIN AC19 [get_ports {ASPIC_r_down_ccd_p[0]}]
set_property PACKAGE_PIN AD19 [get_ports {ASPIC_r_down_ccd_n[0]}]
set_property PACKAGE_PIN AB16 [get_ports {ASPIC_clamp_ccd_p[0]}]
set_property PACKAGE_PIN AC16 [get_ports {ASPIC_clamp_ccd_n[0]}]
set_property PACKAGE_PIN Y15 [get_ports {ASPIC_reset_ccd_p[0]}]
set_property PACKAGE_PIN Y16 [get_ports {ASPIC_reset_ccd_n[0]}]

#(Bank 13)
set_property PACKAGE_PIN R22 [get_ports {ASPIC_nap_ccd[0]}]
set_property PACKAGE_PIN N23 [get_ports {ASPIC_pwdn_ccd[0]}]

#ASPIC control signals
set_property PACKAGE_PIN P23 [get_ports {ASPIC_miso_ccd[0]}]
set_property PACKAGE_PIN T24 [get_ports {ASPIC_ss_t_ccd[0]}]
set_property PACKAGE_PIN T25 [get_ports {ASPIC_ss_b_ccd[0]}]
set_property PACKAGE_PIN R23 [get_ports {ASPIC_spi_reset_ccd[0]}]

set_property PACKAGE_PIN M21 [get_ports {ASPIC_sclk_ccd[0]}]
set_property PACKAGE_PIN M22 [get_ports {ASPIC_mosi_ccd[0]}]
...
set_property PACKAGE_PIN AB24 [get_ports {ldac_C_BIAS_ccd[0]}]
set_property PACKAGE_PIN AA23 [get_ports {din_C_BIAS_ccd[0]}]
set_property PACKAGE_PIN Y23 [get_ports {sync_C_BIAS_ccd[0]}]
set_property PACKAGE_PIN AA24 [get_ports {sclk_C_BIAS_ccd[0]}]


##### signals for CCD 2 ####
##CCD ADC (Bank 15)
set_property PACKAGE_PIN K15 [get_ports {adc_cnv_ccd[1]}]
set_property PACKAGE_PIN C16 [get_ports {adc_sck_ccd[1]}]

set_property PACKAGE_PIN A17 [get_ports {adc_data_t_ccd[1][0]}]
set_property PACKAGE_PIN A18 [get_ports {adc_data_b_ccd[1][0]}]
set_property PACKAGE_PIN B16 [get_ports {adc_data_t_ccd[1][1]}]
set_property PACKAGE_PIN A19 [get_ports {adc_data_b_ccd[1][1]}]
set_property PACKAGE_PIN B19 [get_ports {adc_data_t_ccd[1][2]}]
set_property PACKAGE_PIN B17 [get_ports {adc_data_b_ccd[1][2]}]
set_property PACKAGE_PIN C17 [get_ports {adc_data_t_ccd[1][3]}]
set_property PACKAGE_PIN C19 [get_ports {adc_data_b_ccd[1][3]}]
set_property PACKAGE_PIN J15 [get_ports {adc_data_t_ccd[1][4]}]
set_property PACKAGE_PIN H16 [get_ports {adc_data_b_ccd[1][4]}]
set_property PACKAGE_PIN C18 [get_ports {adc_data_t_ccd[1][5]}]
set_property PACKAGE_PIN D15 [get_ports {adc_data_b_ccd[1][5]}]
set_property PACKAGE_PIN D16 [get_ports {adc_data_t_ccd[1][6]}]
set_property PACKAGE_PIN F15 [get_ports {adc_data_b_ccd[1][6]}]
set_property PACKAGE_PIN G15 [get_ports {adc_data_t_ccd[1][7]}]
set_property PACKAGE_PIN G16 [get_ports {adc_data_b_ccd[1][7]}]

##ASPIC signals (Bank 33)
set_property PACKAGE_PIN AB7 [get_ports {ASPIC_r_up_ccd_p[1]}]
set_property PACKAGE_PIN AC7 [get_ports {ASPIC_r_up_ccd_n[1]}]
set_property PACKAGE_PIN AA9 [get_ports {ASPIC_r_down_ccd_p[1]}]
set_property PACKAGE_PIN AB9 [get_ports {ASPIC_r_down_ccd_n[1]}]
set_property PACKAGE_PIN AC9 [get_ports {ASPIC_clamp_ccd_p[1]}]
set_property PACKAGE_PIN AD9 [get_ports {ASPIC_clamp_ccd_n[1]}]
set_property PACKAGE_PIN AC8 [get_ports {ASPIC_reset_ccd_p[1]}]
set_property PACKAGE_PIN AD8 [get_ports {ASPIC_reset_ccd_n[1]}]

##(Bank 15)
set_property PACKAGE_PIN H17 [get_ports {ASPIC_nap_ccd[1]}]
##(Bank 13)
set_property PACKAGE_PIN N22 [get_ports {ASPIC_pwdn_ccd[1]}]

#ASPIC control signals
set_property PACKAGE_PIN G17 [get_ports {ASPIC_miso_ccd[1]}]
set_property PACKAGE_PIN D19 [get_ports {ASPIC_ss_t_ccd[1]}]
set_property PACKAGE_PIN D20 [get_ports {ASPIC_ss_b_ccd[1]}]
set_property PACKAGE_PIN H18 [get_ports {ASPIC_spi_reset_ccd[1]}]
set_property PACKAGE_PIN E15 [get_ports {ASPIC_sclk_ccd[1]}]
set_property PACKAGE_PIN E16 [get_ports {ASPIC_mosi_ccd[1]}]

##CCD Clocks signals (Bank 33)
set_property PACKAGE_PIN AE8 [get_ports {par_clk_ccd_p[1][0]}]
set_property PACKAGE_PIN AF8 [get_ports {par_clk_ccd_n[1][0]}]
set_property PACKAGE_PIN AE7 [get_ports {par_clk_ccd_p[1][1]}]
set_property PACKAGE_PIN AF7 [get_ports {par_clk_ccd_n[1][1]}]
set_property PACKAGE_PIN AF10 [get_ports {par_clk_ccd_p[1][2]}]
set_property PACKAGE_PIN AF9 [get_ports {par_clk_ccd_n[1][2]}]
set_property PACKAGE_PIN Y11 [get_ports {par_clk_ccd_p[1][3]}]
set_property PACKAGE_PIN Y10 [get_ports {par_clk_ccd_n[1][3]}]

set_property PACKAGE_PIN Y8 [get_ports {ser_clk_ccd_p[1][0]}]
set_property PACKAGE_PIN Y7 [get_ports {ser_clk_ccd_n[1][0]}]
set_property PACKAGE_PIN W10 [get_ports {ser_clk_ccd_p[1][1]}]
set_property PACKAGE_PIN W9 [get_ports {ser_clk_ccd_n[1][1]}]
set_property PACKAGE_PIN V8 [get_ports {ser_clk_ccd_p[1][2]}]
set_property PACKAGE_PIN V7 [get_ports {ser_clk_ccd_n[1][2]}]
set_property PACKAGE_PIN V11 [get_ports {reset_gate_ccd_p[1]}]
set_property PACKAGE_PIN W11 [get_ports {reset_gate_ccd_n[1]}]

## bias DAC ccd2 (bank 12)
set_property PACKAGE_PIN AC23 [get_ports {ldac_C_BIAS_ccd[1]}]
set_property PACKAGE_PIN AA22 [get_ports {din_C_BIAS_ccd[1]}]
set_property PACKAGE_PIN AC24 [get_ports {sync_C_BIAS_ccd[1]}]
set_property PACKAGE_PIN W20 [get_ports {sclk_C_BIAS_ccd[1]}]



##### signals for CCD 3 ####
##CCD ADC (Bank 16)
set_property PACKAGE_PIN J8 [get_ports {adc_cnv_ccd[2]}]
set_property PACKAGE_PIN H9 [get_ports {adc_sck_ccd[2]}]

set_property PACKAGE_PIN A9 [get_ports {adc_data_t_ccd[2][0]}]
set_property PACKAGE_PIN D8 [get_ports {adc_data_b_ccd[2][0]}]
set_property PACKAGE_PIN F8 [get_ports {adc_data_t_ccd[2][1]}]
set_property PACKAGE_PIN D9 [get_ports {adc_data_b_ccd[2][1]}]
set_property PACKAGE_PIN G9 [get_ports {adc_data_t_ccd[2][2]}]
set_property PACKAGE_PIN F9 [get_ports {adc_data_b_ccd[2][2]}]
set_property PACKAGE_PIN G10 [get_ports {adc_data_t_ccd[2][3]}]
set_property PACKAGE_PIN H8 [get_ports {adc_data_b_ccd[2][3]}]
set_property PACKAGE_PIN J13 [get_ports {adc_data_t_ccd[2][4]}]
set_property PACKAGE_PIN J11 [get_ports {adc_data_b_ccd[2][4]}]
set_property PACKAGE_PIN G14 [get_ports {adc_data_t_ccd[2][5]}]
set_property PACKAGE_PIN H11 [get_ports {adc_data_b_ccd[2][5]}]
set_property PACKAGE_PIN H12 [get_ports {adc_data_t_ccd[2][6]}]
set_property PACKAGE_PIN H13 [get_ports {adc_data_b_ccd[2][6]}]
set_property PACKAGE_PIN H14 [get_ports {adc_data_t_ccd[2][7]}]
set_property PACKAGE_PIN J10 [get_ports {adc_data_b_ccd[2][7]}]

##ASPIC signals (Bank 18)

set_property PACKAGE_PIN W1 [get_ports {ASPIC_r_up_ccd_p[2]}]
set_property PACKAGE_PIN Y1 [get_ports {ASPIC_r_up_ccd_n[2]}]
set_property PACKAGE_PIN AB2 [get_ports {ASPIC_r_down_ccd_p[2]}]
set_property PACKAGE_PIN AC2 [get_ports {ASPIC_r_down_ccd_n[2]}]
set_property PACKAGE_PIN AA3 [get_ports {ASPIC_clamp_ccd_p[2]}]
set_property PACKAGE_PIN AA2 [get_ports {ASPIC_clamp_ccd_n[2]}]
set_property PACKAGE_PIN AB1 [get_ports {ASPIC_reset_ccd_p[2]}]
set_property PACKAGE_PIN AC1 [get_ports {ASPIC_reset_ccd_n[2]}]

##(Bank 16)
set_property PACKAGE_PIN E11 [get_ports {ASPIC_nap_ccd[2]}]
##(Bank 13)
set_property PACKAGE_PIN N21 [get_ports {ASPIC_pwdn_ccd[2]}]

#ASPIC control signals
set_property PACKAGE_PIN G11 [get_ports {ASPIC_miso_ccd[2]}]
set_property PACKAGE_PIN F14 [get_ports {ASPIC_ss_t_ccd[2]}]
set_property PACKAGE_PIN F13 [get_ports {ASPIC_ss_b_ccd[2]}]
set_property PACKAGE_PIN D11 [get_ports {ASPIC_spi_reset_ccd[2]}]
set_property PACKAGE_PIN C9 [get_ports {ASPIC_sclk_ccd[2]}]
set_property PACKAGE_PIN B9 [get_ports {ASPIC_mosi_ccd[2]}]

##CCD Clocks signals (Bank 34)
set_property PACKAGE_PIN V2 [get_ports {par_clk_ccd_p[2][0]}]
set_property PACKAGE_PIN V1 [get_ports {par_clk_ccd_n[2][0]}]
set_property PACKAGE_PIN Y3 [get_ports {par_clk_ccd_p[2][1]}]
set_property PACKAGE_PIN Y2 [get_ports {par_clk_ccd_n[2][1]}]
set_property PACKAGE_PIN V4 [get_ports {par_clk_ccd_p[2][2]}]
set_property PACKAGE_PIN W4 [get_ports {par_clk_ccd_n[2][2]}]
set_property PACKAGE_PIN AD1 [get_ports {par_clk_ccd_p[2][3]}]
set_property PACKAGE_PIN AE1 [get_ports {par_clk_ccd_n[2][3]}]

set_property PACKAGE_PIN AF5 [get_ports {ser_clk_ccd_p[2][0]}]
set_property PACKAGE_PIN AF4 [get_ports {ser_clk_ccd_n[2][0]}]
set_property PACKAGE_PIN AE3 [get_ports {ser_clk_ccd_p[2][1]}]
set_property PACKAGE_PIN AE2 [get_ports {ser_clk_ccd_n[2][1]}]
set_property PACKAGE_PIN U2 [get_ports {ser_clk_ccd_p[2][2]}]
set_property PACKAGE_PIN U1 [get_ports {ser_clk_ccd_n[2][2]}]
set_property PACKAGE_PIN AF3 [get_ports {reset_gate_ccd_p[2]}]
set_property PACKAGE_PIN AF2 [get_ports {reset_gate_ccd_n[2]}]

## bias DAC ccd3 (bank 12)
set_property PACKAGE_PIN AD24 [get_ports {ldac_C_BIAS_ccd[2]}]
set_property PACKAGE_PIN AD23 [get_ports {din_C_BIAS_ccd[2]}]
set_property PACKAGE_PIN AB22 [get_ports {sync_C_BIAS_ccd[2]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports ASPIC_miso_ccd*]
set_property IOSTANDARD LVCMOS33 [get_ports ASPIC_ss_*]
set_property IOSTANDARD LVCMOS33 [get_ports ASPIC_spi_reset_ccd*]
set_property IOSTANDARD LVCMOS33 [get_ports ASPIC_sclk_ccd*]
set_property IOSTANDARD LVCMOS33 [get_ports ASPIC_mosi_ccd*]
...
set_property IOSTANDARD LVCMOS33 [get_ports ASPIC_pwdn_ccd*]
