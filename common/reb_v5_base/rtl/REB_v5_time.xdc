...
create_generated_clock -name stable_clk -source [get_pins U_REB_v5/ClockManager_stable_clk/MmcmGen.U_Mmcm/CLKIN1] -master_clock [get_clocks PgpRefClk_P] [get_pins U_REB_v5/ClockManager_stable_clk/MmcmGen.U_Mmcm/CLKOUT0]
create_generated_clock -name sys_clk_local_from_A -source [get_pins U_REB_v5/ClockManager_sys_clk/MmcmGen.U_Mmcm/CLKIN1] -master_clock [get_clocks RXOUTCLK_A] [get_pins U_REB_v5/ClockManager_sys_clk/MmcmGen.U_Mmcm/CLKOUT0]
create_generated_clock -name sys_clk_local_from_B -source [get_pins U_REB_v5/ClockManager_sys_clk/MmcmGen.U_Mmcm/CLKIN1] -master_clock [get_clocks RXOUTCLK_B] [get_pins U_REB_v5/ClockManager_sys_clk/MmcmGen.U_Mmcm/CLKOUT0]
create_generated_clock -name multiboot_clk_from_A -source [get_pins U_REB_v5/ClockManager_sys_clk/MmcmGen.U_Mmcm/CLKIN1] -master_clock [get_clocks RXOUTCLK_A] [get_pins U_REB_v5/ClockManager_sys_clk/MmcmGen.U_Mmcm/CLKOUT1]
create_generated_clock -name multiboot_clk_from_B -source [get_pins U_REB_v5/ClockManager_sys_clk/MmcmGen.U_Mmcm/CLKIN1] -master_clock [get_clocks RXOUTCLK_B] [get_pins U_REB_v5/ClockManager_sys_clk/MmcmGen.U_Mmcm/CLKOUT1]
