...
set_clock_groups -logically_exclusive -group clk_100_Mhz_local_from_A -group clk_100_Mhz_local_from_B
set_clock_groups -logically_exclusive -group clk_25_Mhz_from_A -group clk_25_Mhz_from_B

# Cover mutual exclusions between A derived and B derived clocks
set_clock_groups -logically_exclusive -group clk_100_Mhz_local_from_A -group clk_25_Mhz_from_B
set_clock_groups -logically_exclusive -group clk_25_Mhz_from_A -group clk_100_Mhz_local_from_B

# Set exclusivity for RXOUT clocks in relation to their derived clocks
set_clock_groups -logically_exclusive -group RXOUTCLK_A -group {clk_100_Mhz_local_from_A clk_25_Mhz_from_A}
set_clock_groups -logically_exclusive -group RXOUTCLK_B -group {clk_100_Mhz_local_from_B clk_25_Mhz_from_B}
